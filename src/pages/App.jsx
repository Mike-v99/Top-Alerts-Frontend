...
<style>{`html, body { background: ${T.bg}; margin: 0; padding: 0; overflow-x: hidden; width: 100%; max-width: 100vw; } *, *::before, *::after { box-sizing: border-box; } #root { overflow-x: hidden; max-width: 100vw; } @keyframes slideFromLeft  { from { transform: translateX(-60%); opacity: 0; } to { transform: translateX(0); opacity: 1; } } @keyframes slideFromRight { from { transform: translateX(60%);  opacity: 0; } to { transform: translateX(0); opacity: 1; } } @keyframes slideUpIn { from { transform: translateY(100%); opacity: 0; } to { transform: translateY(0); opacity: 1; } } @keyframes slideDownOut { from { transform: translateY(0); opacity: 1; } to { transform: translateY(100%); opacity: 0; } } .price-slide-up   { animation: slideFromLeft  0.22s cubic-bezier(0.22,1,0.36,1) forwards; } .price-slide-down { animation: slideFromRight 0.22s cubic-bezier(0.22,1,0.36,1) forwards; } @keyframes chartPanelPulse { 0%   { box-shadow: 0 0 0 0px rgba(138,106,0,0.5); } 50%  { box-shadow: 0 0 0 6px rgba(138,106,0,0.15); } 100% { box-shadow: 0 0 0 0px rgba(138,106,0,0); } } .chart-panel-pulse { animation: chartPanelPulse 0.5s ease-out forwards; }`}</style>
